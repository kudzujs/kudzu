...
test("builds TSX into HTML and behavior commands without React", async () => {
  ...
  const release = await readFile(new URL("../dist/releases/0.16.16/index.html", import.meta.url), "utf8")
  ...
  assert.match(docs, /@kudzujs\/core@\^0\.16\.16 typescript/)
  assert.match(docs, /Current 0\.16\.16 production evidence.*benchmark:source-scale.*100,000 modules.*10 GiB heap.*138\.2 ms.*39\.6 \/ 5\.8 ms.*Kudzu 0\.16\.8.*4\.2-9\.9 KiB.*15 \/ 18/s)
  assert.match(examples, /Release 0\.16\.16.*v0\.16\.16.*KUDZU EXAMPLE CATALOG/s)
  assert.match(blog, /Kudzu 0\.16\.16.*v0\.16\.16.*source compiled by the current Kudzu release/s)
  assert.match(html, /class="release-banner" href="\/releases\/0\.16\.16".*Bounded compiler module cache/s)
  assert.match(release, /Kudzu 0\.16\.16.*Keep the symbols.*Release the old trees/s)
  assert.match(release, /100,000 MODULES · 10 GiB HEAP · STABLE SYMBOLS.*BOUNDED COMPILER MEMORY.*npm install @kudzujs\/core@\^0\.16\.16/s)
  assert.match(release, /<title>Kudzu 0\.16\.16 - Bounded compiler module cache<\/title>/)
  assert.match(release, /rel="canonical" href="https:\/\/kudzujs\.cloud\/releases\/0\.16\.16"/)
  assert.match(release, /Measure the retained graph.*Keep 1,024 records.*Preserve stable symbols/s)
