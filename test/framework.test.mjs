...
test("builds TSX into HTML and behavior commands without React", async () => {
  ...
  const release = await readFile(new URL("../dist/releases/0.16.13/index.html", import.meta.url), "utf8")
  ...
  assert.match(docs, /@kudzujs\/core@\^0\.16\.13 typescript/)
  assert.match(docs, /Current 0\.16\.13 route evidence.*138\.2 ms.*39\.6 \/ 5\.8 ms.*Kudzu 0\.16\.8.*4\.2-9\.9 KiB.*15 \/ 18/s)
  assert.match(examples, /Release 0\.16\.13.*v0\.16\.13.*KUDZU EXAMPLE CATALOG/s)
  assert.match(blog, /Kudzu 0\.16\.13.*v0\.16\.13.*source compiled by the current Kudzu release/s)
  assert.match(html, /class="release-banner" href="\/releases\/0\.16\.13".*Route artifact explanations/s)
  assert.match(release, /Kudzu 0\.16\.13.*Explain one route.*Keep the compiler private/s)
  assert.match(release, /AUTHORED SOURCE · SEMANTIC OWNER · EXACT ARTIFACT BYTES.*ROUTE EXPLANATION.*npm install @kudzujs\/core@\^0\.16\.13/s)
  assert.match(release, /<title>Kudzu 0\.16\.13 - Route artifact explanations<\/title>/)
  assert.match(release, /rel="canonical" href="https:\/\/kudzujs\.cloud\/releases\/0\.16\.13"/)
  assert.match(release, /Start from authored files.*Account for artifacts.*Keep context compact/s)
