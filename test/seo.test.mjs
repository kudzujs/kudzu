...
test("generates canonical SEO output for Cloudflare static assets", async () => {
  ...
  const routes = ["/", "/docs", "/example", "/releases/0.8.2", "/releases/0.8.15", "/releases/0.8.16", "/releases/0.8.17", "/example/blog/personal", "/example/blog/personal/demo", "/example/blog/personal/demo/a-room-made-for-reading"]
  try {
