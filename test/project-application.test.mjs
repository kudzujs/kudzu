...
test("establishes the 0.17.0 notification WebSocket ownership contract", { timeout: 120_000 }, async t => {
  ...
  assert.deepEqual(detailArtifacts.handlers, { entries: ["/assets/handlers/AppLayout.js", "/assets/handlers/pages/app/projects/alpha.js"], chunks: [], lazyChunks: [] })
  ...
  assert.deepEqual(helpArtifacts.handlers, { entries: [], chunks: [], lazyChunks: [] })
