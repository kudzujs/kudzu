...
The public commerce fixture prepares generated source and identical assets once per size outside the timed framework interval, then compares Kudzu and Astro with acceptance before timing and rotating cold/warm samples. Its Kudzu adapter now emits only the flattened page props and bounded collection rows actually compiled instead of a 37 MiB nested catalog literal. At 1,000 products and seven rotating runs, Kudzu cold/warm medians are 3,079.0 / 3,170.9 ms and peak RSS is 318,476 KiB versus Astro 3,913.4 / 3,941.1 ms and 409,344 KiB. Kudzu is 21.3% / 19.5% faster and uses 22.2% less peak RSS; it emits 1,011 pages, 10,057,806 B, and digest `468800762dd6977644e9d3f2bf018bd951cf08487fe42f99360d3b55db567cc9`.

At 10,000 products, both targets pass sampled-product acceptance and emit 10,011 pages. Kudzu cold/warm medians are 17,714.7 / 18,239.2 ms versus Astro 22,942.1 / 22,723.6 ms, so build time passes at 22.8% / 19.7% faster. Kudzu emits 96,379,876 B with digest `811234693329ebd61eeceb6cd05e5d52473e5c81972a820253bf1aea664a0910`. Peak RSS remains release-blocking at 1,870,904 KiB versus Astro 613,916 KiB because Kudzu retains the 10,000 route plans needed for its 135 MiB build plan and 31 MiB artifact report.

The final 2026-08-20 completion run passes `npm run check`, all 245 required-Chrome tests, fresh-install package smoke, and the maintained Worker benchmark. The Worker graph is 907 raw / 477 gzip B and the window graph is 14,093 raw / 6,037 gzip B; seven clean builds after one warm-up have a 616.0 ms median. This is a same-target completion diagnostic, not a revision timing claim.
