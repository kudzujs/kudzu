...
**0.7.7:** Imported memo collections. Relative named imports of JSON-safe static arrays can feed state-dependent `useMemo` collection filters while preserving keyed DOM identity without a browser memo cache. See [release notes](./RELEASES.md#077---imported-memo-collections).
