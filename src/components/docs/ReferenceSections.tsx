...
export function BenchmarksSection() {
  return <section className="docs-section" id="benchmarks">
    ...
    <div className="docs-callout"><strong>Current 0.8.52 release context</strong><span>The maintained cross-framework matrix below remains the 0.8.41 snapshot. The 0.8.45 source-scale result remains the latest compiler performance comparison; 0.8.52 moves private mutable refs into owned effect closures and makes no new performance claim.</span></div>
...
export function LimitsSection() {
  return <section className="docs-section" id="limits">
    ...
    <ul className="docs-limits">
      ...
      <li>An ordinary component may declare top-level <code>useRef(null)</code> and <code>useRef(0)</code> values when every direct <code>.current</code> reference belongs to one inline effect setup, its nested callbacks, and cleanup. Kudzu moves them into an invocation-private effect closure for SDK handles, WebSockets, generation tokens, and animation-frame handles. JSX DOM refs remain component-owned; aliases, nonzero initializers, cross-effect/event use, and escaped ref objects are rejected.</li>
