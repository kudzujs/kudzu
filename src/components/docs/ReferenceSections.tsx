...
export function LimitsSection() {
  return <section className="docs-section" id="limits">
    ...
    <ul className="docs-limits">
      <li>Repeated ordinary same-file and relative-imported child components own independent state IDs. Direct reactive conditional branches delete child state on removal and recreate serialized initial values on remount. Anonymous synchronous zero-argument <code>useState</code> initializers may return directly serializable literals; captures, dynamic calls, lazy <code>useReducer</code> initialization, and broader callback/ref ownership remain unsupported.</li>
