...
export function LimitsSection() {
  return <section className="docs-section" id="limits">
    ...
    <ul className="docs-limits">
      ...
      <li>React Router migration input supports only a named or aliased <code>Link</code> used directly in JSX with exactly one static root-relative <code>to</code> and native anchor props. Kudzu applies <code>base</code> and erases the import. Dynamic, object, relative, query-only, hash-only, external destinations, <code>NavLink</code>, router-only props, spreads, conflicting <code>href</code>, default/namespace imports, and non-JSX uses are not supported.</li>
