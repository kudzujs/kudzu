...
export function BenchmarksSection() {
  return <section className="docs-section" id="benchmarks">
    ...
    <BenchmarkTable columns={["Target", "Initial rows", "Initial JS gzip", "Build", "Child update + condition", "Child reverse", "Parent reverse", "Parent remove"]} rows={[
      ["Astro native", "Yes", "287 B", "945 ms", "0.5 ms", "0.3 ms", "3.1 ms", "0.1 ms"],
      ["Kudzu", "Yes", "6.6 KB", "430 ms", "1.2 ms", "0.4 ms", "4.6 ms", "0.6 ms"],
      ["Svelte CSR", "No", "13.1 KB", "956 ms", "2.2 ms", "0.8 ms", "5.4 ms", "1.1 ms"],
      ["Vue CSR", "No", "24.6 KB", "861 ms", "4.3 ms", "2.3 ms", "5.0 ms", "2.0 ms"],
      ["React CSR", "No", "59.5 KB", "1,102 ms", "8.9 ms", "4.2 ms", "7.4 ms", "4.1 ms"]
    ]} />
    <p>The fixture renders 100 keyed parents with 10 keyed child components each. The selected update changes child text and flips its condition while preserving the child root; subsequent operations verify child and parent identity. Kudzu beats Svelte, Vue, and React on all four operations and Astro remains the native lower bound. Sharing inert child-condition branches and descriptors through each live child-list prototype reduced Kudzu's HTML from 676,086 B to 417,086 B and total deploy output from 693,806 B to 435,326 B raw; the sum of gzip-compressed files is 23,473 B. The CSR targets omit initial rows, so output sizes are not architecture-equivalent.</p>
