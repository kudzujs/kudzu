...
export function LimitsSection() {
  return <section className="docs-section" id="limits">
    ...
    <ul className="docs-limits">
      ...
      <li>Keyed lists require local-state maps and intrinsic roots or top-level local or relative-imported row components. One unexported same-file wrapper may receive the state identifier directly and render the map under an intrinsic root. Imported wrappers, package and namespace row imports, reusable aliases, nested dynamic JSX, prop spreads, and derived-expression captures remain unsupported.</li>
