...
export function BenchmarksSection() {
  return <section className="docs-section" id="benchmarks">
    ...
    <div className="docs-callout"><strong>Current 0.8.56 release context</strong><span>The maintained cross-framework matrix below remains the 0.8.41 snapshot. The 0.8.45 source-scale result remains the latest compiler timing comparison; 0.8.56 reduces affected-route development work and makes no new timing claim.</span></div>
