...
CHROME_BIN="/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" \\
  node --test --test-name-pattern="bundles relative TypeScript Workers" test/framework.test.mjs`} />
    ...
    <div className="docs-callout"><strong>Historical comparison</strong><span>This dated 0.7.12 snapshot retains raw arrays in PERFORMANCE.md. It is not a current 0.8.29 framework ranking.</span></div>
    ...
    <p>Older excluded-workspace snapshots remain in the <a href="https://github.com/kudzujs/kudzu/blob/v0.8.29/PERFORMANCE.md">raw performance archive</a> for provenance, but are omitted here because their runners and raw arrays are unavailable.</p>
  </section>
}
