...
export function BenchmarksSection() {
  return <section className="docs-section" id="benchmarks">
    ...
    <div className="docs-callout"><strong>Current 0.8.58 release context</strong><span>The maintained cross-framework matrix below remains the 0.8.41 snapshot. The 0.8.45 source-scale result remains the latest compiler timing comparison; 0.8.58 adds keyed-item draft initialization and makes no new timing claim.</span></div>
