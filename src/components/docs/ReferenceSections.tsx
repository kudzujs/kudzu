...
export function LimitsSection() {
  return <section className="docs-section" id="limits">
    ...
    <ul className="docs-limits">
      ...
      <li><code>useEffect</code> supports inline block-bodied callbacks, one same-component top-level simple <code>const</code> setup function, directly returned inline or simple <code>const</code> cleanup, DOM ownership in ordinary conditional children and supported keyed rows, and literal dependency arrays. Dependencies may be direct JSON-safe primitive state/runtime parameters, destructured child props passed directly from parent state, or one top-level immutable local derived through a supported pure primitive expression from direct state. Derived results use <code>Object.is</code> and latest setup/cleanup evaluation. Keyed rows also accept direct <code>item.&lt;field&gt;</code> primitive properties. Whole-item, nested, prototype-sensitive, object, spread, arbitrary-call, dynamic or indirect callbacks, callback/cleanup parameters or generators, cross-component functions, and other return forms are not supported.</li>
