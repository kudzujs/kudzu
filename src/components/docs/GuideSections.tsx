...
export function ComponentsSection() {
  return <section className="docs-section" id="components">
    ...
    <p>Migration source may retain conventional <code>react</code> imports for supported named or aliased hooks, direct members such as <code>React.useState</code>, same-file <code>memo</code>, inline <code>useCallback</code> and primitive/direct-state expression <code>useMemo</code>, and default, namespace, or named <code>Fragment</code>. Kudzu canonicalizes them before evaluation; memo wrappers become build-time components, callbacks, or same-component reactive expressions rather than a browser cache. React is not loaded or emitted, and a static route remains JavaScript-free.</p>
