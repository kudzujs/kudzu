...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.26">
        <span>v0.7.26</span>
        <strong>React-shaped migration and faster lists</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.26</span> REACT-SOURCE MIGRATION</p>
