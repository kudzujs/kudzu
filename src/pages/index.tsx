...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.22">
        <span>v0.16.22</span>
        <strong>Reactive collection count reuse</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.22</span> COMPILER FRAMEWORK</p>
