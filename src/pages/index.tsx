...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.14.1">
        <span>v0.14.1</span>
        <strong>Nested and object-state collections</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.14.1</span> COMPILER FRAMEWORK</p>
  ...
  return <button onClick={() => setCount(count + 1)}>
    Grown {count} times
        ...
        <section className="model" id="benchmarks">
          <div className="section-title">
            <p className="eyebrow">MEASURED IN 0.14.1</p>
          ...
          <div className="pipeline">
            ...
            <article><span>SESSION</span><h3>26,204 B gzip</h3><p>The two-route session ships nested object-state collections with no component runtime.</p><code>17 unique JavaScript files</code></article>
