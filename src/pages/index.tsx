...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.13.0">
        <span>v0.13.0</span>
        <strong>Production form and server validation</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.13.0</span> COMPILER FRAMEWORK</p>
  ...
  return <button onClick={() => setCount(count + 1)}>
    Grown {count} times
        ...
        <section className="model" id="benchmarks">
          <div className="section-title">
            <p className="eyebrow">MEASURED IN 0.13.0</p>
            <h2>Application behavior.<br />Measured output.</h2>
          </div>
          <div className="pipeline">
            <article><span>NAVIGATION</span><h3>3.6 ms release median</h3><p>List-to-detail completion across seven fresh Chrome profiles, with the complete issue form on the destination.</p><code>npm run benchmark:project-navigation</code></article>
            <article><span>SESSION</span><h3>23,096 B gzip</h3><p>The two-route session ships only the capabilities used by the project application.</p><code>17 unique JavaScript files</code></article>
