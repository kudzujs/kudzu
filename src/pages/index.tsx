...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.27">
        <span>v0.16.27</span>
        <strong>Application verification guidance</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.27</span> COMPILER FRAMEWORK</p>
