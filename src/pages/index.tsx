...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.5">
        <span>v0.16.5</span>
        <strong>Bounded navigation cache</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.5</span> COMPILER FRAMEWORK</p>
  ...
  return <button onClick={() => setCount(count + 1)}>
    Grown {count} times
        ...
        <section className="model" id="benchmarks">
          <div className="section-title">
          <p className="eyebrow">MEASURED IN 0.16.5</p>
