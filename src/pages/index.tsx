...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.8.50">
        <span>v0.8.50</span>
        <strong>Package-neutral shared state IR</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.8.50</span> COMPILER FRAMEWORK</p>
