...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.8.40">
        <span>v0.8.40</span>
        <strong>Property-level effect dependencies</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.8.40</span> COMPILER FRAMEWORK</p>
