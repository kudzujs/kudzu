...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.24">
        <span>v0.16.24</span>
        <strong>Imported article search and benchmark integrity</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.24</span> COMPILER FRAMEWORK</p>
