...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.11">
        <span>v0.7.11</span>
        <strong>Serializable defaults and rest props</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.11</span> REACT-SOURCE MIGRATION</p>
