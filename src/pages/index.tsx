...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.11">
        <span>v0.16.11</span>
        <strong>Structured compiler diagnostics</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.11</span> COMPILER FRAMEWORK</p>
