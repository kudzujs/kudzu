...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.30">
        <span>v0.16.30</span>
        <strong>Binding target specialization</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.30</span> COMPILER FRAMEWORK</p>
