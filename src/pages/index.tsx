...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.19">
        <span>v0.7.19</span>
        <strong>Reusable collection aliases</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.19</span> REACT-SOURCE MIGRATION</p>
