...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.12.4">
        <span>v0.12.4</span>
        <strong>Nested layout evidence decision</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.12.4</span> COMPILER FRAMEWORK</p>
  ...
  return <button onClick={() => setCount(count + 1)}>
    Grown {count} times
        ...
        <section className="model" id="benchmarks">
          <div className="section-title">
            <p className="eyebrow">PRESERVED IN 0.12.4</p>
          ...
          <div className="pipeline">
            ...
            <article><span>SESSION</span><h3>22,663 B gzip</h3><p>The two-route session remains unchanged after the nested-layout evidence decision.</p><code>16 unique JavaScript files</code></article>
