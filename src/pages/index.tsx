...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.25">
        <span>v0.16.25</span>
        <strong>Static content and acceptance alignment</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.25</span> COMPILER FRAMEWORK</p>
