...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.12">
        <span>v0.16.12</span>
        <strong>Bounded application inspection</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.12</span> COMPILER FRAMEWORK</p>
