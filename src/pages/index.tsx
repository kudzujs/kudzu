...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.4">
        <span>v0.7.4</span>
        <strong>Memoized collection pipelines</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.4</span> REACT-SOURCE MIGRATION</p>
