...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.40">
        <span>v0.16.40</span>
        <strong>Same-origin navigation requests</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.40</span> COMPILER FRAMEWORK</p>
