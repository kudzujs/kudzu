...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.19">
        <span>v0.16.19</span>
        <strong>Corrected AI delivery evidence</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.19</span> COMPILER FRAMEWORK</p>
