...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.8.54">
        <span>v0.8.54</span>
        <strong>Inspectable route artifact closure</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.8.54</span> COMPILER FRAMEWORK</p>
