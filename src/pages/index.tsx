...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.8.29">
        <span>v0.8.29</span>
        <strong>Symbol-aware descriptor discovery</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.8.29</span> COMPILER FRAMEWORK</p>
