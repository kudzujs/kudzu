...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.25">
        <span>v0.7.25</span>
        <strong>Router-shaped native navigation</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.25</span> REACT-SOURCE MIGRATION</p>
