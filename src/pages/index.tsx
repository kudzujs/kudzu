...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.11.4">
        <span>v0.11.4</span>
        <strong>Pagination, refresh, and polling policy</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.11.4</span> COMPILER FRAMEWORK</p>
  ...
  return <button onClick={() => setCount(count + 1)}>
    Grown {count} times
        ...
        <section className="model" id="benchmarks">
          <div className="section-title">
            <p className="eyebrow">MEASURED IN 0.11.4</p>
            <h2>Application behavior.<br />Measured output.</h2>
          </div>
          <div className="pipeline">
            <article><span>NAVIGATION</span><h3>1.3 ms release median</h3><p>Published list-to-detail completion across 21 fresh Chrome profiles, with a 1.2–1.6 ms range.</p><code>npm run benchmark:project-navigation</code></article>
            <article><span>SESSION</span><h3>22,124 B gzip</h3><p>The complete two-route list/detail JavaScript session, including URL pagination and polling policy.</p><code>16 unique JavaScript files</code></article>
