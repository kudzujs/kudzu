...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.10">
        <span>v0.16.10</span>
        <strong>Apache Answer authentication journey</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.10</span> COMPILER FRAMEWORK</p>
