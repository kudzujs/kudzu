...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.8.43">
        <span>v0.8.43</span>
        <strong>Three-boundary callback ownership</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.8.43</span> COMPILER FRAMEWORK</p>
