...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.26">
        <span>v0.16.26</span>
        <strong>Product documentation and package hygiene</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.26</span> COMPILER FRAMEWORK</p>
