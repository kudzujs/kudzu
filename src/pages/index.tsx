...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.16.16">
        <span>v0.16.16</span>
        <strong>Bounded compiler module cache</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.16.16</span> COMPILER FRAMEWORK</p>
