...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <a className="release-banner" href="/releases/0.7.29">
        <span>v0.7.29</span>
        <strong>Hermetic TypeScript checks</strong>
      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span>v0.7.29</span> REPRODUCIBLE TYPECHECKS</p>
