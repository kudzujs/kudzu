...
export const metadata = {
  ...
  description:
    "Browse static site examples compiled with Kudzu 0.15.1, starting with sixteen distinct blog formats.",
  lang: "en",
  locale: "en_US",
  siteName: "Kudzu",
    ...
    <div className="example-catalog">
      <header className="site-header example-header">
        ...
        <nav aria-label="Example navigation">
          <a href="/">Home</a>
          <a href="/docs">Docs</a>
          <a href="/releases/0.15.1">Release 0.15.1</a>
      ...
      <main className="example-main">
        <section className="example-intro">
          <p className="eyebrow"><span>v0.15.1</span> KUDZU EXAMPLE CATALOG</p>
          <h1>
            Sites worth
            <br />
            <em>taking apart.</em>
          ...
          <p>
            Complete site patterns compiled by Kudzu 0.15.1, their project
