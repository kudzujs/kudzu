...
export const metadata = {
  ...
  description:
    "Browse static site examples built with Kudzu, starting with sixteen distinct blog formats.",
  lang: "en",
  locale: "en_US",
  siteName: "Kudzu",
    ...
    <div className="example-catalog">
      ...
      <main className="example-main">
        <section className="example-intro">
          <p className="eyebrow">KUDZU EXAMPLE CATALOG</p>
          <h1>
            Sites worth
            <br />
            <em>taking apart.</em>
          ...
          <p>
            Complete site patterns, their project structure, and the code behind
            them. The catalog starts with blogs and grows from here.
          </p>
        </section>
