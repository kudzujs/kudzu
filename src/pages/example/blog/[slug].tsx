...
export const metadata = {
  ...
  description:
    "Explore a complete static blog example, its project structure, and the Kudzu 0.16.15 TSX source behind it.",
  lang: "en",
  locale: "en_US",
  siteName: "Kudzu",
  themeColor: "#8d52ff",
    ...
    <div className="example-showcase">
      <header className="site-header example-header">
        ...
        <nav aria-label="Example navigation">
          ...
          <a href="/releases/0.16.15">Kudzu 0.16.15</a>
      ...
      <main className="showcase-main">
        <section className="showcase-intro">
          <p className="eyebrow"><span>v0.16.15</span> BLOG EXAMPLE / {blog.label}</p>
          <h1>
            {blog.name}
            <br />
            <em>blog.</em>
