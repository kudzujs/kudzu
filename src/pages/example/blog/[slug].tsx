...
export const metadata = {
  ...
  description:
    "Explore a complete static blog example, its project structure, and the Kudzu 0.13.2 TSX source behind it.",
  lang: "en",
  locale: "en_US",
  siteName: "Kudzu",
  themeColor: "#8d52ff",
    ...
    <div className="example-showcase">
      <header className="site-header example-header">
        ...
        <nav aria-label="Example navigation">
          ...
          <a href="/releases/0.13.2">Kudzu 0.13.2</a>
      ...
      <main className="showcase-main">
        <section className="showcase-intro">
          <p className="eyebrow"><span>v0.13.2</span> BLOG EXAMPLE / {blog.label}</p>
          <h1>
            {blog.name}
            <br />
            <em>blog.</em>
