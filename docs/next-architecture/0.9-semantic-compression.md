...
**Status:** active. Session 05A pins WorkLedger revision `3d8bf2130ec1d7698bff07fb00726b2bb94d20d4`. Its component-owned conversation object crosses one ordinary prop boundary, where `conversation.messages` feeds both an effect dependency and a keyed list. The reduced repeated/conditional fixture fails at that property dependency with the current compiler; flattening or prop decomposition is the only current workaround.
