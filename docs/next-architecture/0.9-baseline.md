...
Next work: 0.9.0-03 / Session 03A Equivalence Fixture And IR Snapshots
```
...
| Component | Direct prop signals are represented, but general immutable object-property dependencies across ordinary component boundaries remain unproven. |
