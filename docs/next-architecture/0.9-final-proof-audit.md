...
| 1,000 | Kudzu optimized | 1,011 | 7,874 / 7,853 ms | 743,512 KiB | 10,164,835 |
| 1,000 | Astro | 1,011 | 6,178 / 6,620 ms | 408,060 KiB | 14,896,056 |

Kudzu's 1,000-product cold median remains 27.5% slower and peak RSS remains
82.2% higher. Import-free plain TypeScript lowering and identity-cached JSON
safety reduce the prior Kudzu cold median from 8,896 ms and preserve output
digest `61eb1b7c633a2facabb782bc654a5ad07169aeb82cf47dbccda9b9e7303a716e`,
but do not meet the 5% threshold. The 10,000-product run is blocked until the
1,000-product gate passes.
