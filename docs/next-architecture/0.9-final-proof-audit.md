...
Work Item `0.9.0-07` is blocked as of 2026-08-19 at measured code revision
`3e22e3a`.
...
| Stateful | Local five-target matrix passes seven rotating builds/browser profiles | Static sibling and the complete frozen C2 ownership/resilience surface remain incomplete. |
...
| Resource | Local five-target Worker/navigation matrix passes seven rotating builds/browser profiles | Repeated disposal, late release, replacement, and static exclusion coverage remain incomplete. |
...
Astro 7.1.3 React-island variants now join React 19.2.8, Vue 3.5.40,
Svelte 5.56.7, and Kudzu in the local runtime and capability matrices. One
warm-up, seven rotating builds, and seven fresh rotating Chrome profiles pass
for all five targets. The missing frozen C2/C5 cases above remain blockers.
...
6. Keep model-driven AI migration measurement in the 1.0 work item.
