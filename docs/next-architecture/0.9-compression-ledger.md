...
LOC falls by 9. Core semantic LOC is 5,264, up 303 from 0.8.62 after adding the
proved Derived, shared-action, and component-property semantics and then removing
32 lines in Session 06B. Existing baseline capability-family bytes remain
unchanged; new fixtures select only existing families.
