...
lines. The later Work Item 07 scaling fast paths add 47 lines, so the current
candidate is 5,311 lines, up 350 from 0.8.62. Existing baseline capability-family
